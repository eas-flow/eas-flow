...
| ------------- | -------------- | ----------------------------------------------------------------------------------------------------- |
| `explorer`    | `develop-work` | Locates target files, existing implementation patterns, and impact scope before implementation starts |
| `doc-auditor` | `doc-sync`     | Compares `docSync` target docs against SSOT files and lists discrepancies                             |
